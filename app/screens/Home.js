  ...
  render() {
    ...
    return (
      ...
      <View style={styles.container}>
        <View style={{position: 'absolute', zIndex: 1, alignSelf: 'center', paddingTop: 70, paddingBottom: 10, backgroundColor: "#6acbdd", width: '100%', height: 130, borderBottomLeftRadius: 15, borderBottomRightRadius: 15}}>
          ...
          <View style={styles.footer}>
            ...
            <View style={{ marginTop: 5 }}>
              ...
              >
                ...
                >
                  <Image source={require("../assets/messi.png")}></Image>
                </Animated.View>
